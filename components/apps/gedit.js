    ...
    render() {
        return (
            <div className="w-full h-full relative flex gap-5 p-5  bg-[#282c34] text-white select-none ">
                <a href="https://www.linkedin.com/in/gokulakrishnankumaran/" className="flex flex-col h-max justify-center items-center" target="_blank">
                    <img src="/images/logos/linkedin.png" className="h-16 w-16"></img>
                    <span classname="text-center">linkedin</span>
                </a>
                <a href="krishnansai71@gmail.com" className="flex flex-col h-max justify-center items-center"  target="_blank">
                    <img src="/images/logos/email.png" className="h-16 w-16"></img>
                    <span>mail</span>
                </a>
                <a href="https://medium.com/@krishnansai/whoami-32a9019ebd5" className="flex flex-col h-max justify-center items-center" target="_blank">
                    <img src="/images/logos/medium.png" className="h-16 w-16"></img>
                    <span>medium</span>
                </a>
                <a href="https://www.youtube.com/@twinsaitech" className="flex flex-col h-max justify-center items-center" target="_blank">
                    <img src="/images/logos/yt.png" className="h-16 w-16"></img>
                    <span>YouTube</span>
                </a>
            </div>
        )
